INSERT INTO `spengerspital`.`greeting` (`id`, `content`) VALUES ('2', 'Hi');
INSERT INTO `spengerspital`.`greeting` (`id`, `content`) VALUES ('3', 'Lo');
INSERT INTO `spengerspital`.`greeting` (`id`, `content`) VALUES ('4', 'Ho');
...
INSERT INTO `spengerspital`.`codeable_concept` (`id`, `cc_text`, `cc_practitioner_fk`, `en_codeableconcept_fk`) VALUES ('123123', 'Text', 'p1', 'enc1');
...
INSERT INTO `spengerspital`.`diagnosis` (`id`, `rank`, `diag_codeableconcept_fk`, `enc_diagnosis_fk`) VALUES ('dia1', '9', '123', 'enc1');
INSERT INTO `spengerspital`.`reference` (`id`, `display`, `reference`, `type`, `enc_reason_reference_fk`, `enc_ep_of_ca_reference_fk`, `enc_appointment_reference_fk`, `diag_reference_fk`) VALUES ('r1', 'alternativer Text', '/api/id_von_ref', 'SomeEntity', 'enc1', 'enc1', 'enc1', 'dia1');
INSERT INTO `spengerspital`.`status_history` (`id`, `pp_end`, `pp_start`, `status`, `en_statushistory_fk`) VALUES ('sh1', '2021-04-15 20:15:45.000000', '2020-04-15 20:15:49.000000', 'inprogress', 'enc1');
...
INSERT INTO `spengerspital`.`address` (`id`, `a_city`, `a_country`, `a_district`, `pp_end`, `pp_start`, `a_postalcode`, `a_state`, `a_practitioner_fk`, `a_patient_fk`) VALUES ('addr1', 'Orasje', 'BiH', 'Orase', '2099-12-31 16:36:34.000000', '2020-04-27 16:36:49.000000', '1111', 'BiH', 'p1', '7439re');
...
-- Medication
INSERT INTO `spengerspital`.`reference` (`id`, `display`, `reference`, `type`) VALUES ('ref1', 'string', 'reference', 'type');
INSERT INTO `spengerspital`.`quantity` (`id`, `code`, `comperator`, `system`, `unit`, `value`) VALUES ('quan1', 'code', 'bigger', 'system', 'unit', '10');
INSERT INTO `spengerspital`.`ratio` (`id`, `rat_denom_fk`, `rat_num_fk`) VALUES ('rat1', 'quan1', 'quan1');
INSERT INTO `spengerspital`.`batch` (`id`, `expiration_date`, `lot_number`) VALUES ('bat1', '2020-09-17 12:58:23.000000', '1');
INSERT INTO `spengerspital`.`medication` (`id`, `status`, `med_ratio_fk`, `med_bat_fk`, `med_code_fk`, `med_form_fk`) VALUES ('med1', 'active', 'rat1', 'bat1', '123', '123');
INSERT INTO `spengerspital`.`identifier` (`id`, `i_code`, `pp_end`, `pp_start`, `i_system`, `i_value`) VALUES ('iukjfdoas', 'usual', '2020-09-21 10:31:15.000000', '2020-09-21 10:31:16.000000', 'http://url.com', '574395742357');
INSERT INTO `spengerspital`.`ingredient` (`id`, `is_active`, `ind_item_cc_fk`, `med_manufacturer_reference_fk`, `ind_ratio_fk`, `ind_medication_fk`) VALUES ('ind1', b'1', '123', 'ref1', 'rat1', 'med1');
